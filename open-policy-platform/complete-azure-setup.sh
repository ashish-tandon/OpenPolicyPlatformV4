...
# Open Policy Platform V4 - Complete Azure Setup (Azure Environment)
# This script completes the Azure setup after provider registration
...
echo "🔧 Completing Azure Setup for Open Policy Platform V4..."
echo ""
...
print_success "Azure Key Vault created successfully!"
